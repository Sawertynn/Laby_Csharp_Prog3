    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // MY TESTING SPACE
            Console.WriteLine("\n\nMy testing space\n");
            var t1 = new Cone(circle4, 5);
            var t2 = new Cone(circle4, 5);
            var t3 = new Cone(circle4, 5);
            var nsh = Shape3D.NumberOfCreatedObjects;
            var nCone = Cone.NumberOfCreatedObjects;
            var nCyl = Cylinder.NumberOfCreatedObjects;

            Console.WriteLine($"NumberOfShapes3D: {nsh}");
            Console.WriteLine($"NumberOfCones: {nCone}");
            Console.WriteLine($"NumberOfCylinders: {nCyl}");
        }
